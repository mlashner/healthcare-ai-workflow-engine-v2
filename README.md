...
A 10-minute click-through (home → Ava Nguyen review → approval → trace → eval) is in [`docs/interview-demo.md`](docs/interview-demo.md). Main control-plane decisions while building with Cursor: [`docs/ai-development-log.md`](docs/ai-development-log.md). Comparison with sibling `healthcare-ai-workflow-engine` and a production recommendation: [`docs/comparison-with-healthcare-ai-workflow-engine.md`](docs/comparison-with-healthcare-ai-workflow-engine.md).
